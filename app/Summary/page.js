    ...
    <main className="flex min-h-dvh w-full bg-slate-50 relative">
      ...
      <div className="flex-1 p-10">
        ...
        <header className="mb-10">
          ...
          <p className="text-lg text-gray-500 mt-1">A snapshot of your clinic's current activity and finances.</p>
        </header>
              ...
              <Table className="text-base">
                ...
                <TableBody>
                  {recentVisits.map((visit) => (
                    <TableRow key={visit.id} className="text-gray-700 border-b last:border-0 hover:bg-slate-50/50">
                      <TableCell className="font-semibold py-5">{visit.patient}</TableCell>
          ...
          <Card className="shadow-sm border-none">
            ...
            <CardContent className="px-8 pb-8">
              <div className="space-y-8">
                ...
                <ExpenseItem label="Medical Supplies" amount="$4,200" percentage={65} color="bg-[#002D58]" />
                <ExpenseItem label="Staff Salaries" amount="$6,800" percentage={85} color="bg-[#A0CE66]" />
                <ExpenseItem label="Facility Rent" amount="$1,300" percentage={40} color="bg-blue-400" />
                
                {/* Total Summary Section */}
                <div className="pt-6 border-t mt-8">
                  <div className="flex justify-between items-center mb-6">
                    <span className="text-lg font-bold text-gray-700">Total Expenses</span>
                    <span className="text-xl font-bold text-red-600">$12,300</span>
                  </div>
